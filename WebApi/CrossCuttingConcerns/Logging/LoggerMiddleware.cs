...
namespace WebApi.CrossCuttingConcerns.Logging
{
    public class LoggerMiddleware
    {
        ...
        (RequestDelegate next, IOptions<LoggerOptions> options,
            ILogger logger, IFirestoreProvider firestoreProvider)
        {
            _next = next;
        ...
        public async Task InvokeAsync(HttpContext httpContext,
            ILogModelCreator logCreator)
        {
            LogModel log = logCreator.LogModel;
        ...
        private void LogError(LogModel log, Exception exception)
        {
